...
export default function VerifyContent() {
  ...
  return (
    <div className="rounded-2xl border border-border/40 bg-card p-8 sm:p-10 shadow-sm text-center">
      ...
      {status === "success" && (
        <div className="flex flex-col items-center gap-5">
          <div className="w-16 h-16 rounded-full bg-green-50 border border-green-200 dark:bg-green-950/60 dark:border-green-800/60 flex items-center justify-center">
      ...
      {status === "error" && (
        <div className="flex flex-col items-center gap-5">
          <div className="w-16 h-16 rounded-full bg-red-50 border border-red-200 dark:bg-red-950/60 dark:border-red-800/50 flex items-center justify-center">
